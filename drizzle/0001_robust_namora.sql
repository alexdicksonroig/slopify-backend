...
ALTER TABLE "product_variants" ADD COLUMN "unit_amount" integer NOT NULL;--> statement-breakpoint
ALTER TABLE "product_variants" ADD COLUMN "currency" text NOT NULL;--> statement-breakpoint
